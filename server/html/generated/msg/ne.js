...
BlocklyGamesMsg["Games.puzzle"] = "Holodeck";  // untranslated
BlocklyGamesMsg["Games.maze"] = "Turbolift";  // untranslated
BlocklyGamesMsg["Games.bird"] = "Bridge";  // untranslated
BlocklyGamesMsg["Games.turtle"] = "Security";  // untranslated
BlocklyGamesMsg["Games.movie"] = "Movie";  // untranslated
BlocklyGamesMsg["Games.music"] = "Music";  // untranslated
BlocklyGamesMsg["Games.pondTutor"] = "Weapons";  // untranslated
...
BlocklyGamesMsg["Games.nextLevel"] = "You may receive your next level isolinear chip.";  // untranslated
BlocklyGamesMsg["Games.finalLevel"] = "You may receive your next level isolinear chip.";  // untranslated
...
BlocklyGamesMsg["Puzzle.animal1"] = "Riker";  // untranslated
BlocklyGamesMsg["Puzzle.animal1Trait1"] = "William";  // untranslated
BlocklyGamesMsg["Puzzle.animal1Trait2"] = "Beard";  // untranslated
BlocklyGamesMsg["Puzzle.animal1HelpUrl"] = "https://memory-alpha.fandom.com/wiki/William_T._Riker";  // untranslated
BlocklyGamesMsg["Puzzle.animal2"] = "Beverly";  // untranslated
BlocklyGamesMsg["Puzzle.animal2Trait1"] = "Doctor";  // untranslated
BlocklyGamesMsg["Puzzle.animal2Trait2"] = "Blue";  // untranslated
BlocklyGamesMsg["Puzzle.animal2HelpUrl"] = "https://memory-alpha.fandom.com/wiki/Beverly_Crusher";  // untranslated
BlocklyGamesMsg["Puzzle.animal3"] = "Picard";  // untranslated
BlocklyGamesMsg["Puzzle.animal3Trait1"] = "Captain";  // untranslated
BlocklyGamesMsg["Puzzle.animal3Trait2"] = "Bald";  // untranslated
BlocklyGamesMsg["Puzzle.animal3HelpUrl"] = "https://memory-alpha.fandom.com/wiki/Jean-Luc_Picard";  // untranslated
BlocklyGamesMsg["Puzzle.animal4"] = "Geordi";  // untranslated
BlocklyGamesMsg["Puzzle.animal4Trait1"] = "Engineer";  // untranslated
BlocklyGamesMsg["Puzzle.animal4Trait2"] = "Visor";  // untranslated
BlocklyGamesMsg["Puzzle.animal4HelpUrl"] = "https://memory-alpha.fandom.com/wiki/Geordi_La_Forge";  // untranslated
BlocklyGamesMsg["Puzzle.picture"] = "picture:";  // untranslated
BlocklyGamesMsg["Puzzle.legs"] = "rank:";  // untranslated
...
BlocklyGamesMsg["Puzzle.helpText"] = "For each crewmember (orange), attach its picture, choose the order of rank (1 being highest rank), and make a stack of its traits.";  // untranslated
...
BlocklyGamesMsg["Maze.helpOneTopBlock"] = "On this level, you need to stack together all of the blocks in the workspace.";  // untranslated
...
BlocklyGamesMsg["Bird.noWorm"] = "does not have dilithium";  // untranslated
BlocklyGamesMsg["Bird.heading"] = "heading";  // untranslated
BlocklyGamesMsg["Bird.noWormTooltip"] = "The condition when the Enterprise has not retrieved the dilithium.";  // untranslated
...
BlocklyGamesMsg["Bird.positionTooltip"] = "x and y mark the Enterprise's position. When x = 0 the Enterprise is near the left edge, when x = 100 it's near the right edge. When y = 0 the Enterprise is at the bottom, when y = 100 it's at the top.";  // untranslated
BlocklyGamesMsg["Bird.helpHeading"] = "Change the heading angle to make the Enterprise retrieve the dilithium and dock at the spaceport.";  // untranslated
BlocklyGamesMsg["Bird.helpHasWorm"] = "Use this block to go in one heading if you have the dilithium, or a different heading if you don't have the dilithium.";  // untranslated
...
BlocklyGamesMsg["Turtle.moveTooltip"] = "Moves the monitor forward or backward by the specified amount.";  // untranslated
...
BlocklyGamesMsg["Turtle.turnTooltip"] = "Turns the monitor left or right by the specified number of degrees.";  // untranslated
...
BlocklyGamesMsg["Turtle.turtleVisibilityTooltip"] = "Makes the minotor (circle and arrow) visible or invisible.";  // untranslated
BlocklyGamesMsg["Turtle.hideTurtle"] = "hide monitor";  // untranslated
BlocklyGamesMsg["Turtle.showTurtle"] = "show monitor";  // untranslated
BlocklyGamesMsg["Turtle.printHelpUrl"] = "https://en.wikipedia.org/wiki/Printing";  // untranslated
BlocklyGamesMsg["Turtle.printTooltip"] = "Draws text in the minotor's direction at its location.";  // untranslated
...
BlocklyGamesMsg["Pond.cannonTooltip"] = "Fire torpedoes. Specify a direction (0-360) and a range (0-70).";  // untranslated
BlocklyGamesMsg["Pond.swimTooltip"] = "Fly forward. Specify a direction (0-360).";  // untranslated
BlocklyGamesMsg["Pond.stopTooltip"] = "Stop flying. Player will slow to a stop.";  // untranslated
...
BlocklyGamesMsg["Pond.helpUseScan"] = "Your solution works, but you can do better. Use 'scan' to tell the torpedoes how far to shoot.";  // untranslated
BlocklyGamesMsg["Pond.helpText1"] = "Use the 'torpedoes' command to hit the target. The first parameter is the angle, the second parameter is the range. Find the right combination.";  // untranslated
...
BlocklyGamesMsg["Pond.helpText3a"] = "This asteroid moves back and forth, making it hard to hit. The 'scan' expression returns the exact range to the asteroid in the specified direction.";  // untranslated
BlocklyGamesMsg["Pond.helpText3b"] = "This range is exactly what the 'torpedoes' command needs to fire accurately.";  // untranslated
BlocklyGamesMsg["Pond.helpText4"] = "This asteroid is too far away to use torpedoes (which has a limit of 70 meters). Instead, use the 'fly' command to start flying towards the asteroid and crash into it.";  // untranslated
BlocklyGamesMsg["Pond.helpText5"] = "This asteroid is also too far away to use torpedoes. But you are too weak to survive a collision. Fly towards the asteroid while your horizontal location is less than 50. Then 'stop' and use the torpedoes.";  // untranslated
BlocklyGamesMsg["Pond.helpText6"] = "This asteroid will move away when it is hit. Fly towards it if it is out of range (70 meters).";  // untranslated
