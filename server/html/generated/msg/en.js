...
BlocklyGamesMsg["Games.puzzle"] = "Holodeck";
BlocklyGamesMsg["Games.maze"] = "Turbolift";
BlocklyGamesMsg["Games.bird"] = "Bridge";
BlocklyGamesMsg["Games.turtle"] = "Security";
BlocklyGamesMsg["Games.movie"] = "Movie";
BlocklyGamesMsg["Games.music"] = "Music";
BlocklyGamesMsg["Games.pondTutor"] = "Weapons";
...
BlocklyGamesMsg["Games.nextLevel"] = "You may receive your next level isolinear chip.";
BlocklyGamesMsg["Games.finalLevel"] = "You may receive your next level isolinear chip.";
...
BlocklyGamesMsg["Puzzle.animal1"] = "Riker";
BlocklyGamesMsg["Puzzle.animal1Trait1"] = "William";
BlocklyGamesMsg["Puzzle.animal1Trait2"] = "Beard";
BlocklyGamesMsg["Puzzle.animal1HelpUrl"] = "https://memory-alpha.fandom.com/wiki/William_T._Riker";
BlocklyGamesMsg["Puzzle.animal2"] = "Beverly";
BlocklyGamesMsg["Puzzle.animal2Trait1"] = "Doctor";
BlocklyGamesMsg["Puzzle.animal2Trait2"] = "Blue";
BlocklyGamesMsg["Puzzle.animal2HelpUrl"] = "https://memory-alpha.fandom.com/wiki/Beverly_Crusher";
BlocklyGamesMsg["Puzzle.animal3"] = "Picard";
BlocklyGamesMsg["Puzzle.animal3Trait1"] = "Captain";
BlocklyGamesMsg["Puzzle.animal3Trait2"] = "Bald";
BlocklyGamesMsg["Puzzle.animal3HelpUrl"] = "https://memory-alpha.fandom.com/wiki/Jean-Luc_Picard";
BlocklyGamesMsg["Puzzle.animal4"] = "Geordi";
BlocklyGamesMsg["Puzzle.animal4Trait1"] = "Engineer";
BlocklyGamesMsg["Puzzle.animal4Trait2"] = "Visor";
BlocklyGamesMsg["Puzzle.animal4HelpUrl"] = "https://memory-alpha.fandom.com/wiki/Geordi_La_Forge";
BlocklyGamesMsg["Puzzle.picture"] = "picture:";
BlocklyGamesMsg["Puzzle.legs"] = "rank:";
...
BlocklyGamesMsg["Puzzle.helpText"] = "For each crewmember (orange), attach its picture, choose the order of rank (1 being highest rank), and make a stack of its traits.";
...
BlocklyGamesMsg["Maze.helpOneTopBlock"] = "On this level, you need to stack together all of the blocks in the workspace.";
...
BlocklyGamesMsg["Bird.noWorm"] = "does not have dilithium";
BlocklyGamesMsg["Bird.heading"] = "heading";
BlocklyGamesMsg["Bird.noWormTooltip"] = "The condition when the Enterprise has not retrieved the dilithium.";
BlocklyGamesMsg["Bird.headingTooltip"] = "Move in the direction of the given angle: 0 is to the right, 90 is straight up, etc.";
BlocklyGamesMsg["Bird.positionTooltip"] = "x and y mark the Enterprise's position. When x = 0 the Enterprise is near the left edge, when x = 100 it's near the right edge. When y = 0 the Enterprise is at the bottom, when y = 100 it's at the top.";
BlocklyGamesMsg["Bird.helpHeading"] = "Change the heading angle to make the Enterprise retrieve the dilithium and dock at the spaceport.";
BlocklyGamesMsg["Bird.helpHasWorm"] = "Use this block to go in one heading if you have the dilithium, or a different heading if you don't have the dilithium.";
...
BlocklyGamesMsg["Turtle.moveTooltip"] = "Moves the monitor forward or backward by the specified amount.";
BlocklyGamesMsg["Turtle.moveForward"] = "move forward by";
BlocklyGamesMsg["Turtle.moveBackward"] = "move backward by";
BlocklyGamesMsg["Turtle.turnTooltip"] = "Turns the monitor left or right by the specified number of degrees.";
...
BlocklyGamesMsg["Turtle.turtleVisibilityTooltip"] = "Makes the minotor (circle and arrow) visible or invisible.";
BlocklyGamesMsg["Turtle.hideTurtle"] = "hide monitor";
BlocklyGamesMsg["Turtle.showTurtle"] = "show monitor";
BlocklyGamesMsg["Turtle.printHelpUrl"] = "https://en.wikipedia.org/wiki/Printing";
BlocklyGamesMsg["Turtle.printTooltip"] = "Draws text in the minotor's direction at its location.";
...
BlocklyGamesMsg["Pond.cannonTooltip"] = "Fire torpedoes. Specify a direction (0-360) and a range (0-70).";
BlocklyGamesMsg["Pond.swimTooltip"] = "Fly forward. Specify a direction (0-360).";
BlocklyGamesMsg["Pond.stopTooltip"] = "Stop flying. Player will slow to a stop.";
...
BlocklyGamesMsg["Pond.helpUseScan"] = "Your solution works, but you can do better. Use 'scan' to tell the torpedoes how far to shoot.";
BlocklyGamesMsg["Pond.helpText1"] = "Use the 'torpedoes' command to hit the target. The first parameter is the angle, the second parameter is the range. Find the right combination.";
BlocklyGamesMsg["Pond.helpText2"] = "This target needs to be hit many times. Use a 'while (true)' loop to do something indefinitely.";
BlocklyGamesMsg["Pond.helpText3a"] = "This asteroid moves back and forth, making it hard to hit. The 'scan' expression returns the exact range to the asteroid in the specified direction.";
BlocklyGamesMsg["Pond.helpText3b"] = "This range is exactly what the 'torpedoes' command needs to fire accurately.";
BlocklyGamesMsg["Pond.helpText4"] = "This asteroid is too far away to use torpedoes (which has a limit of 70 meters). Instead, use the 'fly' command to start flying towards the asteroid and crash into it.";
BlocklyGamesMsg["Pond.helpText5"] = "This asteroid is also too far away to use torpedoes. But you are too weak to survive a collision. Fly towards the asteroid while your horizontal location is less than 50. Then 'stop' and use the torpedoes.";
BlocklyGamesMsg["Pond.helpText6"] = "This asteroid will move away when it is hit. Fly towards it if it is out of range (70 meters).";
